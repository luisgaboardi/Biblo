                ...
                >
                  {(provided, snapshot) => (
                    <div
                      ...
                      className={`flex items-center gap-3 p-3 bg-white border-2 rounded-xl transition-all ${
                        snapshot.isDragging
                          ? "border-biblo-blue shadow-lg z-50"
                          : "border-gray-100"
                      }`}
                    >
                      <div
                      ...
                      <span className="flex-1 text-sm font-bold text-gray-700">
                        <span className="text-biblo-blue mr-2">
                          {oIdx + 1}.
                        </span>
                        {opt}
                      </span>
